...
#define cpu_map_h
  ...
  #define ROT_STEP_DDR   DDRC
  #define ROT_STEP_PORT  PORTC
  #define ROT_STEP_BIT   3   // Uno Analog Pin 3

  #define ROT_DIR_DDR    DDRC
  #define ROT_DIR_PORT   PORTC
  #define ROT_DIR_BIT    4   // Uno Analog Pin 4
